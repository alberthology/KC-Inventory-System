...
*/
           ...
           <div class="small-box bg-info">
             <div class="inner">
               ...
               <h5> Orders Completed For This Month</h5>
               <h5>A total of <b><?php echo $total_orders; ?></b> completed purchase</h5>
             </div>
             <div class="icon">
         ...
         <div class="col-lg-3 col-6">
           ...
           <div class="small-box bg-warning">
             <div class="inner">
               ...
               <h5>Pending Purchase For This Month</h5>
               <h5>A total of <b><?php echo $total_orders; ?></b> pending orders</h5>
             </div>
             <div class="icon">
                 ...
                 <div class="col-md-4">
                   ...
                   <div class="progress-group">
                     ...
                     <div class="progress progress-sm">
                       <div class="progress-bar text-bg-danger" style="width: <?php if ($total_complete_purchase != 0) {
                                                                                echo $completed_order_percent;
                                                                              } else {
                                                                                echo "0";
                                                                              } ?>%"></div>
                     </div>
               ...
               <div class="row">
                 ...
                 <div class="col-md-3 col-6">
                   <div class="text-center border-end">
                     ...
                     <!-- <h5 class="fw-bold mb-0">₱<?php //echo number_format($current_sales,2);
                                                    ?></h5> -->
...
WHERE o.total_price = o.payment;
                 ...
                 <div class="col-md-3 col-6">
                   <div class="text-center border-end">
                     ...
                     <span class="text-uppercase">COMPLETED SALES</span>
                   </div>
                 </div>
