                ...
                (SELECT SUM(CASE WHEN quantity_in_stock = 0 THEN 1 ELSE 0 END) FROM product_table) AS out_of_stock_products";
                     ...
                     <div class="info-box">
                         ...
                         <div class="info-box-content">
                             ...
                             <span class="info-box-number">
                                 <?php echo $display_count['total_products']; ?>
                                 <small> product/s available</small>
                             </span>
                         </div>
                     </div>
                 </div>
                 ...
                 <div class="col-12 col-sm-6 col-md-3">
                     <div class="info-box mb-3">
                         <span class="info-box-icon bg-blue elevation-1"><i class="fas fa-tags"></i></span>

                         <div class="info-box-content">
                             <span class="info-box-text">Total Brands</span>
                             <span class="info-box-number"><?php echo $display_count['total_brands']; ?>
                                 <small> brand/s available</small>
                                     ...
                                     <div class="col-12">
                                         <div class="card">
                                             <div class="card-header">
                                                 <div class="row">
                                                     <div class="col-auto">
                                                         <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#add-product"><i class="fas fa-plus"></i> &nbsp Product</button>
                                                     </div>
                                                 </div>
                                                 <!-- /.card-header -->
                                                 <div class="card-body">
                             ...
                             <div class="modal fade" id="add-category">
                                 <div class="modal-dialog modal-md">
                                     <div class="modal-content">
                                         ...
                                         <div class="modal-body">
                                             <form id="categoryForm" action="../functions/insert_sql.php" method="post">
                                                 <div class="row">
                                                     <div class="col-md-12 mb-3">
                                                         <input type="text" name="category" class="form-control form-control-md uppercase-input" placeholder="Category" required>
                                                     </div>
                                                     <div class="col-md-12 mb-3">
                                                         <input type="text" name="brand" class="form-control form-control-md uppercase-input" placeholder="Brand" required>
                                                     </div>
                                                     <div class="col-md-12 mb-3">
                                                     ...
                                                     <div class="col-md-12 mb-5">
                                                         <input type="text" name="description" class="form-control form-control-md uppercase-input" placeholder="Brand Description (Optional)" hidden>
                                                     </div>
                                                 </div>
                                                 <hr>
                                                 <div class="row">
                                                     ...
                                                     <div class="col-md-6">
                                                         <button type="submit" id="submitButton" name="submit-category" class="btn btn-primary btn-sm" style="float: right;">Add</button>
                                             ...
                                             <!--                                             <script>
                                                document.getElementById('submitButton').addEventListener('click', function (e) {
                                                    ...
                                                    Swal.fire({
                                                        title: 'Please Confirm if the Data are Valid Before Continuing',
                                                        text: "",
                                                        icon: 'question',
                                             ...
                                             <form id="editBrandForm" action="../functions/edit_sql.php" method="post">
                                                 ...
                                                 <div class="row">
                                                     ...
                                                     <div class="col-md-12">
                                                         ...
                                                         <input type="text" name="description" id="edit_description" class="form-control" placeholder="Brand Description" hidden>
                                                     </div>
                                                 </div>
                                             </form>
                                         </div>
