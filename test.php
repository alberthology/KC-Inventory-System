                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="functions/insert_sql.php" method="post">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <select name="category_id" id="category_select" class="form-control form-control-md">
                                                            <option selected hidden disabled>Select Category</option>
                                                            <?php
                                                    ...
                                                    <div class="col-md-12" id="new_category_input" style="display: none;">
                                                        <input type="text" name="new_category" class="form-control form-control-md" placeholder="Add New Category">
                                                    </div>
                                                    <script>
                                                        document.getElementById('category_select').addEventListener('change', function() {
                                                            var newCategoryInput = document.getElementById('new_category_input');
                                                            if (this.value === 'new_category') {
                                                                newCategoryInput.style.display = 'block'; // Show input field
                                                            } else {
                                                                newCategoryInput.style.display = 'none'; // Hide input field
                                                            }
                                                        });
                                                    </script>
