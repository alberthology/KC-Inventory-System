       ...
       <div class="row">
         <div class="col-md-3">
           ...
           <div class="card card-dark card-outline">
             <div class="card-body box-profile">
               <!-- <div class="text-center">
                 <img class="profile-user-img img-fluid img-circle" src="dist/img/user4-128x128.jpg" alt="Logo">
               </div> -->

               <h3 class="profile-username text-center"><?php echo $_SESSION['Name']; ?>
               </h3>

               <p class="text-muted text-center text-capitalize"><?php echo htmlspecialchars($_SESSION['role']); ?></p>

               <ul class="list-group list-group-unbordered mb-3">
                 <li class="list-group-item">
                   <center><b>KC CLOSET</b></center>
                   <center><b>INVENTORY SYSTEM</b></center>
                 </li>
           ...
           <div class="card card-dark">
             ...
             <div class="card-body">
               <center>
                 <strong><i class="fas fa-user mr-1"></i> User ID</strong>

                 <p class="text-muted">
                   <?php echo "00" . $_SESSION['id']; ?>
               </center>
               </p>
             ...
             <div class="card-body">
               <div class="tab-content">
                 <div class="active tab-pane" id="activity">
                   ...
                   <form method="POST" action="../functions/edit_sql.php">
                     <?php
                     ...
                     <div class="form-group row">
                       ...
                       <div class="col-sm-10">
                         <input type="text" class="form-control" name="Fullname" placeholder="Firstname" value="<?php echo $row['full_name'] ?>" required>
                       </div>
                     </div>
                     <div class="form-group row">
                     ...
                     <!-- <div class="form-group row">
                       ...
                       <div class="col-sm-10">
                         <input type="text" class="form-control" name="role" placeholder="User Role" value="<?php echo $row['role'] ?>" disabled>
                       </div>
                     </div> -->
                     <div class="form-group row">
